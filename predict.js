function update_prediction() {
    $.getJSON('http://158.108.182.9:3000/get_predict', function(data) {
        ...
        else if (prediction_value >= 0.25 && prediction_value < 50) prediction_content += "Tomorrow is a normal day 4U";
        ...
        document.getElementById("predict").setAttribute("data-bs-content", prediction_content);
    });
